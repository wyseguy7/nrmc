...
import numpy as np
new_beta = 2
process = CenterOfMassFlow(state_new, beta=new_beta/2., measure_beta=new_beta, center=(20,20)) # TODO fill in args
...
try:
    ...
    for i in range(30000000):
        ...
        if i % 10000 == 0:
            ...
            filepath = os.path.join(process.folder_path, 'center_of_mass', '{}_{}_{}.png'.format(date, process.run_id, i))
            f.savefig(filepath)
            plt.close()
