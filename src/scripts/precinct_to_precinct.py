...
from src.precinct_flow import PrecintFlow
...
process = PrecintFlow(state_new, beta=1, measure_beta=2, center=(20, 20)) # TODO fill in args
...
try:
    ...
    with open('precinct_to_precinct_{}.pkl'.format(date), mode='wb') as f:
